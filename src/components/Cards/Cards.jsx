...
const Cards = ({ data, handleChats, curUser, handleModal, star_ratings, handleRatings }) => {
                ...
                <Stack direction="row" alignItems="center" spacing={2}>
                    {
                        curUser && (
                            <Stack>
                                ...
                                <img
                                    src={
                                        curUser !== 'ai' ? UserImage : AIIMage 
                                    }
                                    alt='profile pic' width={65} height={69} />
                            </Stack>
                    ...
                    <Stack direction="column" spacing={1}>
                        ...
                        
                        {
                            ...
                            lineheight="21.79px"
                            >{
                                data?.['aiResponse']?.['answer'] ? data['aiResponse']?.['answer'] : response
                            }</Typography>
                        }
                        <Stack direction="row" spacing={5} alignItems="center">
                            ...
                            }
                            {
                                ...
                                <p style={{
                                    ...
                                    {
                                        location.pathname !== '/' ?
                                        new Date(data?.['aiResponse']?.['ai_time']).toLocaleString([], {
                                            hour: '2-digit',
                                            minute: '2-digit'
                                        }) 
                                        :
                ...
                
                {
                    ...
                    <>
                        ...
                        <Stack direction="row" spacing={2} alignItems="center">
                            ...
                            fontFamily="Open Sans"
                            fontWeight={400}
                            >{data?.['aiResponse']?.['feedback']}</Typography>
                        </Stack>
                    </>
                }
            </Stack>
