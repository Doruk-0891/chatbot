...
const InitialChat = ({handleChats, chats}) => {
    return (
        <Box
        height={600}
        display="flex"
        ...
        p={2}
        >
            <Typography variant="h2" component="h2" fontFamily='Ubuntu' >How Can I Help You Today?</Typography>
            ...
            >
                {
                    InitialQuestions.map((item, idx) => {
                        ...
                        return (
                            <Cards data={data} key={idx} handleChats={() => handleChats(data)} />
                        );
                    })
                }
            </Box>
